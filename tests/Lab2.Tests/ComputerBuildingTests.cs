...
public static class ComputerBuildingTests
{
    ...
    private static readonly IList<Ssd> Ssds = new List<Ssd>
    {
        ...
        new Ssd("ssd", SsdConnector.Sata, 256, 1000, 30),
    };
    ...
    private static readonly IList<PowerUnit> PowerUnits = new List<PowerUnit>
    {
        ...
        new PowerUnit("pu", 200),
        new PowerUnit("pu2", 10),
    };
    ...
    [Fact]
    public static void ComputerBuildSuccTest()
    {
        ComputerSpecification spec = new ComputerSpecification
                .Builder()
            .Name("Asus2 Test")
            .Motherboard("Asus Test")
            .Cpu("IntelTest")
            .Cooler("cooler1")
            .Gpu("Nvidia 3090 Ti")
            .Ssd("ssd")
            .Ram("KingstonTest")
            .PcBody("Kingston test")
            .PowerUnit("pu")
            .PcBody("body1")
            .Build()
            .Ok();
        ...
        Assert.Equal("Asus2 Test", comp.Computer?.Name);
    }

    [Theory]
    [InlineData("cooler1", "pu", "Motherboard doesn't support cpu", true)]
    [InlineData("cooler1", "pu2", "unsuitable powerUnit, disclaimer of warranty", false)]
    [InlineData("cooler2", "pu", "unsuitable cooler, disclaimer of warranty", false)]
    public static void ComputerBuildFailTest(string cooler, string powerUnit, string resultingMessage, bool watchErr)
    {
        ComputerSpecification spec = new ComputerSpecification
                .Builder()
            .Name("Asus Test")
        ...
        Assert.Equal(resultingMessage, watchErr ? comp.Problems[0].Message : comp.Messages[0]);
    }
}